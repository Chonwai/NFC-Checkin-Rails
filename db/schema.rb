...
ActiveRecord::Schema[7.0].define(version: 2024_11_13_174116) do
  ...
  create_table "activities", id: :uuid, default: -> { "gen_random_uuid()" }, force: :cascade do |t|
    ...
    t.string "qr_code_uuid", null: false
  ...
  create_table "temp_users", id: :uuid, default: -> { "gen_random_uuid()" }, force: :cascade do |t|
    ...
    t.index ["device_id", "activity_id"], name: "index_temp_users_on_device_id_and_activity_id", unique: true
